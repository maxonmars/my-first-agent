...
/** Добавляется к TASK_INSTRUCTION только при непустом списке инвариантов. */
export const TASK_INVARIANTS_INSTRUCTION =
  "Если реплика пользователя конфликтует с обязательными инвариантами, верни действие reply: в answer назови нарушаемые правила, объясни отказ и предложи допустимую альтернативу. Такой ход не продвигает задачу — не выполняй шаг, не предлагай план и не завершай проверку.";
